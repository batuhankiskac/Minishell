...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/14 23:16:21 by bkiskac           #+#    #+#             */
/*   Updated: 2025/05/14 23:16:22 by bkiskac          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
 * count_words_until_pipe - count WORD tokens up to next PIPE or end
 */
...
/*
 * init_command_args - allocate args array and set argc
 */
...
/*
 * populate_args - fill cmd->args from tokens, advance *t_ptr past words
 */
...
/*
 * set_command_name - set cmd->cmd to first argument if present
 */
...
/*
 * parse_commands - for each t_command, build its args[] and argc
 *
